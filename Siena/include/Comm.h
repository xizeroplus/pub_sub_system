...
//
//
// $Id: Comm.h,v 1.1 2003/07/09 20:17:31 carzanig Exp $
//
#ifndef _Comm_h
#define _Comm_h
 ...
 *  local TCP port at creation time.  Then, it receives packets by
 *  accepting new connections, reading one packet from each
 *  connection, and closing connections immediately after reading one
 *  packet.
 **/
...
/** UDP-based receiver
 *
 *  this receiver uses a UDP port to receive packets.  It creates a
 *  local UDP port, accepting packets from it.
 **/
